...
import com.wangzhe.dianping.common.*;
...
public class SellerController {
    ...
    @AdminPermission
    @ResponseBody
    public FrontDisplay down(@RequestParam(value = "id")Integer id) throws BusinessException {
        SellerModel sellerModel = sellerService.changeStatus(id, 1);
        return FrontDisplay.create(sellerModel);
    }

    @RequestMapping(value = "up", method = RequestMethod.POST)
    @AdminPermission
    @ResponseBody
    public FrontDisplay up(@RequestParam(value = "id")Integer id) throws BusinessException {
